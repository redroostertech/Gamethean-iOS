...
class SliderViewController:  UIViewController, UIScrollViewDelegate, GIDSignInDelegate, GIDSignInUIDelegate {
  ...
  // MARK: - Use Case: Setup scroll view
  ...
  private func createSlides() -> [Slide] {
    ...
    slide1.labelDesc.text = "Discover new and interesting gamers nearby."

    let slide2:Slide = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slide
    slide2.imageView.image = UIImage(named: "Untitled-1-2")
    slide2.labelDesc.text = "Swipe right to game with someone or swipe left to pass"
  ...
  // MARK: - Use Case: Setup Google signin client
  private func setupGoogleSignIn() {
    GIDSignIn.sharedInstance().delegate = self
    GIDSignIn.sharedInstance().uiDelegate = self
  }

  // MARK: - Use Case: Configure UI buttons
...
//        }
  ...
  private func fade(fromRed: CGFloat,
                    fromGreen: CGFloat,
                    fromBlue: CGFloat,
                    fromAlpha: CGFloat,
                    toRed: CGFloat,
  ...
  // MARK: - Use Case: Log user in via Google
...
//            }
  ...
  // MARK: - Use Case: Log user in via Facebook
  ...
  func SignInApi() {
      ...
      let parameter: [String: Any]? = ["fb_id": self.my_id!,
