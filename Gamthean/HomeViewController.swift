...
//        myImage.addGestureRecognizer(tapGestureRecognizer)
    ...
    func ShowPeopleApi(){
        ...
        let parameter:[String:Any]?  = ["fb_id":UserDefaults.standard.string(forKey:"uid")!,"lat_long":UserDefaults.standard.string(forKey:"lat")!+","+UserDefaults.standard.string(forKey:"lon")!,"device":"iOS","distance":UserDefaults.standard.string(forKey: "distance")!,"age_min":"18","age_max":UserDefaults.standard.string(forKey: "age")!,"gender":UserDefaults.standard.string(forKey: "gender")!,"version":floatVersion!]
